...
Public Class iPlayer_DAL
    ...
    Public Class Musica
        ...
        Public Shared Sub Alterar(ByVal NomeMusica As String, ByVal Ano As Integer, ByVal Faixa As Integer, ByVal Comentarios As String, ByVal Letra As String, ByVal NumMusica As Integer, ByVal FaixaTotal As Integer, ByVal Url As String)
            ...
            Try
                ...
                DAL.ExecuteNonQuery("Update Musica set NomeMusica=?, Url=?, Ano=?,  Faixa=?, Comentarios=? , Letra=?, FaixaTotal=?  WHERE NumMusica=?", Parametros)
    ...
    Public Class Playlist
        ...
        Public Shared Sub LimparMusicasAntigas()
            ...
            Try
                ...
                'remove todas as musicas que fazem parte da playlist Acrescentadas
                DAL.ExecuteNonQuery("Delete  from MusicaPlaylist where NumPlaylist=?", Parametros)
                ...
                parametro.Value = 5
                Parametros.Add(parametro)
                'remove todas as musicas que fazem parte da playlist MaisReproduzidas
                DAL.ExecuteNonQuery("Delete  from MusicaPlaylist where NumPlaylist=?", Parametros)
                ...
                parametro.Value = 6
                Parametros.Add(parametro)
                'remove todas as musicas que fazem parte da playlist Reproduzidas
                DAL.ExecuteNonQuery("Delete  from MusicaPlaylist where NumPlaylist=?", Parametros)
    ...
    Public Class Interprete
        ...
        Public Shared Sub Alterar(ByVal nummusica As Integer, ByVal nomeinterprete As String, ByVal nomegrupo As String)
            'vai buscar o numero do interprete relacionado se tiver
            ...
            Try
                ...
                Else
                    ...
                    If nomeinterprete <> Nothing Then
                        Parametros.Clear()
                        parametro = New OleDbParameter("nomeinterprete", OleDb.OleDbType.VarChar)
                        parametro.Value = nomeinterprete
                        Parametros.Add(parametro)
                    Else
                        ...
                        nomeinterprete = DAL.ExecuteScalar("Select nomeInterprete from Interprete where numinterprete=?", Parametros)
                        If nomeinterprete = Nothing Then
                            nomeinterprete = ""
                        End If
                    End If

                    If nomegrupo <> Nothing Then
                        Parametros.Clear()
                    ...
                    Else
                        ...
                        nomegrupo = DAL.ExecuteScalar("Select nomegrupo from Interprete where numinterprete=?", Parametros)
                        If nomegrupo = Nothing Then
                            nomegrupo = ""
                        End If
                    End If
    ...
    Public Class Album
        ...
        Public Shared Sub Alterar(ByVal nummusica As Integer, ByVal nomeAlbum As String, ByVal numCD As Integer, ByVal numCDTotal As Integer)
            'vai buscar o numero do album relacionado se tiver
            ...
            Try
                ...
                Else
                    ...
                    Else
                        ...
                        nomeAlbum = DAL.ExecuteScalar("Select nomeAlbum From Album where numAlbum=?", Parametros)
                        If nomeAlbum = Nothing Then
                            nomeAlbum = ""
                        End If
                    End If

                    If numCD <> Nothing Then
                        parametro = New OleDbParameter("numCD", OleDb.OleDbType.Integer)
                        parametro.Value = numCD
                        Parametros.Add(parametro)
                    Else
                        Parametros.Clear()
                        ...
                        numCD = DAL.ExecuteScalar("Select numCD From Album where numAlbum=?", Parametros)
                        If numCD = Nothing Then
                            numCD = 0
                        End If
                    End If

                    If numCDTotal <> Nothing Then
                        parametro = New OleDbParameter("numcdtotal", OleDb.OleDbType.Integer)
                        parametro.Value = numCDTotal
                        Parametros.Add(parametro)
                    Else
                        Parametros.Clear()
                        ...
                        numCDTotal = DAL.ExecuteScalar("Select numcdtotal From Album where numAlbum=?", Parametros)
                        If numCDTotal = Nothing Then
                            numCDTotal = 0
                        End If
                    End If
                    ...
                    DAL.ExecuteNonQuery("Update album set nomealbum=? , numCD=?,  numcdtotal=? WHERE numalbum=?", Parametros)
                End If
            ...
            Try
                ...
                Else
                    ...
                    For i As Integer = 0 To numGenero.Count - 1
                        ...
                        Else
                            parametro = New OleDbParameter("numGenero", OleDb.OleDbType.Integer)
                            parametro.Value = numGenero(i)
                            Parametros.Add(parametro)
                            NomeGenero = DAL.ExecuteScalar("Select nomeGenero from Genero where numGenero=?", Parametros)
                        End If
