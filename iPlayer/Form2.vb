...
Public Class JanelaInformacoes
    ...
    Sub BuscarInformacoes(ByVal nummusica As Integer)
        ...
        Try
            ValidTextFaixa1.Text = DataTableSemNome.Rows(0).Item("Faixa")
            If ValidTextFaixa1.Text = 0 Then
                ValidTextFaixa1.Text = ""
            End If
        Catch ex As Exception
        End Try

        Try
            ValidTextFaixa2.Text = DataTableSemNome.Rows(0).Item("FaixaTotal")
            If ValidTextFaixa2.Text = 0 Then
                ValidTextFaixa2.Text = ""
            End If
        Catch ex As Exception
        End Try

        Try
            ValidTextNDisco1.Text = DataTableSemNome.Rows(0).Item("NumCD")
            If ValidTextNDisco1.Text = 0 Then
                ValidTextNDisco1.Text = ""
            End If
        Catch ex As Exception
        End Try

        Try
            ValidTextNDisco2.Text = DataTableSemNome.Rows(0).Item("NumCDTotal")
            If ValidTextNDisco2.Text = 0 Then
                ValidTextNDisco2.Text = ""
            End If
        Catch ex As Exception
        End Try
    ...
    Sub GuardarInformacoes()
        ...
        If ValidTextAno.Text = "" Then
            ValidTextAno.Text = 0
        End If
        If ValidTextFaixa1.Text = "" Then
            ValidTextFaixa1.Text = 0
        End If
        If ValidTextFaixa2.Text = "" Then
            ValidTextFaixa2.Text = 0
        End If
        If ValidTextNDisco1.Text = "" Then
            ValidTextNDisco1.Text = 0
        End If
        If ValidTextNDisco2.Text = "" Then
            ValidTextNDisco2.Text = 0
        End If

        iPlayer_DAL.Musica.Alterar(TextBoxNomeMus.Text, CInt(ValidTextAno.Text), CInt(ValidTextFaixa1.Text), TextBoxComentarios.Text, RichTextBoxLetra.Text, nummusica, CInt(ValidTextFaixa2.Text), Nothing)
        iPlayer_DAL.Interprete.Alterar(nummusica, TextBoxInterprete.Text, TextBoxGrupo.Text)
        iPlayer_DAL.Album.Alterar(nummusica, TextBoxAlbum.Text, CInt(ValidTextNDisco1.Text), CInt(ValidTextNDisco2.Text))
    ...
    Private Sub BtnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOK.Click
        ...
        Else
            ...
            JanelaPrincipal.ListView1.Items(indexActual).SubItems(3).Text = TextBoxInterprete.Text
            JanelaPrincipal.ListView1.Items(indexActual).SubItems(4).Text = TextBoxAlbum.Text
            JanelaPrincipal.ListView1.Items(indexActual).SubItems(5).Text = ValidTextAno.Text
